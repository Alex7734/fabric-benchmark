...
const runPerformanceTest = async () => {
  ...
  executeGenericPollingPerformance(getAndroidCpuAndMemoryUsageForApp, /* args */ { appState }, /* interval */ FIVE_SECONDS_MS, TEST_DURATION);
  
  await stopScreenRecording(driver, /* fileName */ 'views_performance_test');
};
